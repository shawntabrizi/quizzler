...
export default defineConfig({
    ...
    webServer: {
        ...
        port: 5302,
        // Compile the test host against a dedicated registry/session/signals/game
        // stack. The player-facing address file is never used by destructive
        // E2E tests.
        env: {
            ...process.env,
            VITE_QUIZZLER_REGISTRY: e2eContracts.registry,
            VITE_QUIZZLER_SESSION_REGISTRY: e2eContracts.sessionRegistry,
            VITE_QUIZZLER_PACK_SIGNALS: e2eContracts.packSignals,
